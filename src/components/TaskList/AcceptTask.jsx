function AcceptTask({data}) {
    return (
        <div key={data.id} className=" flex-shrink-0 h-full w-[300px] bg-orange-400 rounded-xl ">
            ...
            <div className="flex justify-between mt-6" >
                <button className="ml-5  bg-green-500 py-1 px-2 text-sm">Mark as Completed</button>
                <button className="mr-5 bg-red-500 py-1 px-2 text-sm">Mark as Failed</button>
            </div>
